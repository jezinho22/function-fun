...
function sumAndMultiply(a, b, c) {
	...
	let added = sum(a, b)[0]; // because sum returns an array
	array.push(sum(added, c)[0]);

	let timesed = multiply(a, b)[0];
	array.push(multiply(timesed, c)[0]);

	let addSentence = a + " and " + b + " and " + c + " sum to " + array[0] + ".";
	array.push(addSentence);

	let timesSentence =
		"The product of " + a + " and " + b + " and " + c + " is " + array[1] + ".";
	array.push(timesSentence);
	console.log(array);
	return array;
}
